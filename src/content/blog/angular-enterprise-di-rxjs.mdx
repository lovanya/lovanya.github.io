...
>
> **Q5（思考）**：你在信锐时期的 Ionic + Angular 项目里是怎么做混合开发的？Web / iOS / Android 三端共享代码的比例是多少？踩过哪些坑？<AIAsk question="你在信锐时期的 Ionic + Angular 项目里是怎么做混合开发的？Web / iOS / Android 三端共享代码的比例是多少？踩过哪些坑？" />
