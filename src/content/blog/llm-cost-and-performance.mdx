...
**OpenAI** 自动缓存**>= 1024 tokens** 的 prompt 前缀（gpt-4o 是 1024，**gpt-4o-mini 是 2048**），命中部分**便宜 50%**（cache write 不额外收费，cache read 是基础价 50%）。**Anthropic** 提供 5 分钟 TTL 的 prompt cache，支持 4 个 breakpoints（Sonnet 4 / Opus 4 / Haiku 4 / Claude 3.5 Sonnet 均支持）。
