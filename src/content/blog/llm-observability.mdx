...
- **延迟是概率分布**——同样问题，LLM 可能在 200ms 也可能在 4s 回答
...
**修法**：优化 prompt，明确"先判断用户意图，再决定调哪个工具"。
...
**修法**：search_web 第三方 API 不稳定，加超时 + 重试 + fallback。
