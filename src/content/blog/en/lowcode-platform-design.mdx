...
1. **The "ERP semi-low-code project" on resume is scarce experience.** **Low-code is not replacing development**, **it's an engineering pattern of 80% generic business + 20% custom development**.
