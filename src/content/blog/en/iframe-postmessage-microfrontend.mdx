...
1. **The FinSpread 30% authorization cost reduction  is iframe practice.**Understanding same-origin / cross-origin iframe + authorization logic relationship is core to commercialized products.
...
Take **iframe cross-domain deployment reducing authorization cost by 30%** as an example—this is a typical iframe deployment scenario for commercial products:

### 4.1 Scenario Description

```
Product architecture:
  large ERP main:  finui.example.com (main site)
...
Effect: customer pays for FinSpread independently,  revenue +30%
```
