...
<Mermaid client:load caption="Figure 1: LLM lifecycle cost breakdown" chart={`pie title Typical Enterprise LLM Cost Breakdown
...
<Mermaid client:load caption="Figure 2: LLM inference loop" chart={`flowchart LR
...
<Mermaid client:load caption="Figure 3: PagedAttention page mapping" chart={`flowchart TB
  subgraph requestOne["Request 1: 500 tokens"]
    P1[Page 1: 256 tokens]
    P2[Page 2: 244 tokens]
  end
  subgraph requestTwo["Request 2: 1500 tokens"]
...
<Mermaid client:load caption="Figure 4: Quantization method selection" chart={`flowchart TD
...
<Mermaid client:load caption="Figure 5: Speculative decoding sequence" chart={`sequenceDiagram
...
<Mermaid client:load caption="Figure 6: Production deployment selection" chart={`flowchart TD
