...
The [OWASP LLM Top 10](https://genai.owasp.org/llmrisk/llm01-prompt-injection/) lists **LLM01 Prompt Injection** as the #1 risk for LLM apps (both direct and indirect fall under LLM01; indirect is a particularly dangerous subset).
