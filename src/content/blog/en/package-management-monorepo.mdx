...
1. **The ERP Monorepo is a real project.**5+ sub-packages (ui / utils / eslint-config / ts-config / cli) architecture, **single-repo multi-package**is the standard answer for admin backends.
