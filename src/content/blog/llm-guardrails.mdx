...
[OWASP LLM Top 10](https://genai.owasp.org/llmrisk/llm01-prompt-injection/) 把 **LLM01 Prompt Injection** 列为 LLM 应用的头号风险（direct + indirect 都是 LLM01 范畴，indirect 是其中特别危险的子集）。
...
- **永远多层防御**：单一防线**一定会被绕过**，**defense-in-depth** 才是关键。
