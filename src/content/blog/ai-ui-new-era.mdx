...
description: Generative UI、Agent 优先、对话即操作——AI 时代 UI 设计的 7 大范式转移、3 个实战模式、近未来趋势
pubDate: 2026-07-07
...
function Message({ message }) {
  // message.parts 包含 LLM 流式返回的多个 parts
  // 可以是 text、tool-call、UI 组件、JSON 数据
...
**LLM 返回的是 JSON schema，前端根据 schema 渲染对应组件**。
...
**Vercel AI SDK 的 useChat 支持 tool call UI**：
