...
1. **ERP Monorepo 是真实项目**。5+ 子包（ui / utils / eslint-config / ts-config / cli）的架构，**单仓多包**是中后台标准答案。
...
**生产案例**：大型 ERP 用 Changesets 后，**发版错误率从每月 1-2 次降到 0**——版本号、changelog、tag 全自动。
...
**下一篇**：前端工程化体系——CI/CD / 规范 / 评审 / 团队沉淀, + 两段工程化经验。
